...
export const FilterData = {
    ...
    role: [
      ...
      },
      {
        ...
        list: [
          ...
          {
            index: 5,
            content: 'Sales Development Rep',
          },
          {
            index: 6,
            content: 'Sales Engineer',
          },
          {
            index: 7,
      ...
      },
      {
        ...
        list: [
          ...
          {
            index: 3,
            content: 'Community / Events Marketing',
          },
          {
            index: 4,
          ...
          {
            index: 5,
            content: 'Lifecycle / Email Marketing',
          },
          {
            index: 6,
            content: 'Marketing Analytics & Ops',
          },
          {
            index: 7,
      ...
      },
      {
        ...
        list: [
          ...
          {
            index: 2,
            content: 'People Ops Management',
          },
          {
            index: 3,
            content: 'People Ops Specialist',
          },
          {
            index: 4,
            content: 'Recruiter',
          ...
          {
            index: 5,
            content: 'Recruiting Coordinator',
          },
          {
            index: 6,
            content: 'Sourcer',
      ...
      },
      {
        ...
        list: [
          ...
          {
            index: 2,
            content: 'Financial Management / Analysis',
          },
          {
            index: 3,
  ...
  expertise_: [
    ...
    {
      index: 2,
      content: 'Career advice (e.g., interview, job search..)',
    },
    {
      index: 3,
      content: 'Portfolio & resume',
    ...
    {
      index: 7,
      content: 'Soft skills (e.g., communication..)',
    },
  ],
};
